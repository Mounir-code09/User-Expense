...
def load_user(username: str):
    """Load user profile or return blank default template."""
...
def cat_v(category_name: str):
    """Validate if category is in VALID_CATEGORIES list."""
...
def normalize_username(name: str):
    """Normalize username: trim and title-case for consistent storage."""
